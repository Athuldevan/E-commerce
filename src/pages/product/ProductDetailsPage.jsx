            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex space-x-3 pt-2">
                  ...
                  {/* <button className="flex-1 border-2 border-indigo-600 text-indigo-600 py-3 px-6 rounded-lg font-semibold hover:bg-indigo-50 transition-colors duration-200">
                    Buy Now
                  </button> */}
                </div>
              </div>
