              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Order #1234 from John Doe</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Jane Smith joined the platform</p>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-700">
                ...
                <tbody className="divide-y divide-gray-700">
                  <tr>
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium">#12345</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm">John Smith</td>
                    <td className="px-4 py-4 whitespace-nowrap">
                      <span className="px-2 py-1 text-xs rounded-full bg-green-900 text-green-200">Completed</span>
                    </td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm">May 15, 2023</td>
                  ...
                  <tr>
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium">#12344</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm">Sarah Johnson</td>
                    <td className="px-4 py-4 whitespace-nowrap">
                      <span className="px-2 py-1 text-xs rounded-full bg-yellow-900 text-yellow-200">Processing</span>
                    </td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm">May 14, 2023</td>
                  ...
                  <tr>
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium">#12343</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm">Michael Brown</td>
                    <td className="px-4 py-4 whitespace-nowrap">
                      <span className="px-2 py-1 text-xs rounded-full bg-blue-900 text-blue-200">Shipped</span>
                    </td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm">May 14, 2023</td>
                  ...
                  <tr>
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium">#12342</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm">Emily Davis</td>
                    <td className="px-4 py-4 whitespace-nowrap">
                      <span className="px-2 py-1 text-xs rounded-full bg-red-900 text-red-200">Cancelled</span>
                    </td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm">May 13, 2023</td>
